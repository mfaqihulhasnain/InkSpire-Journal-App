...
export default async function JournalEntryPage({ params }) {
  ...
  const mood = getMoodById(entry.mode); // ✅ changed mood → mode

  return (
    <>
      {/* Header with Mood Image */}
      {entry.modeImgUrl && (   /* ✅ changed moodImageUrl → modeImgUrl */
        <div className="relative h-48 md:h-64 w-full">
          <Image
            src={entry.modeImgUrl}   /* ✅ changed moodImageUrl → modeImgUrl */
